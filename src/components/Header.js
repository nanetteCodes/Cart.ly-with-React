        ...
        cartItems = this.state.cart.map(product =>{
			return(
				<li className="cart-item" key={product.name}>
                    <img className="product-image" src={product.filename} />
        ...
        return(
            <header>
                <div className="container">
                    <div className="brand">
                        <img className="logo" src="icons/CartlyLogo.png" alt="Cartly Logo"/>
                    </div>
                    <div className="cart">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="numHead">{this.props.totalItems}</td>
                                    </tr>
                                    <tr>
                                        <td>Sub Total</td>

                                        <td className="numHead">{this.props.total}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <a className="cart-icon" href="#" onClick={this.handleCart.bind(this)} ref="cartButton">
                            <img className={this.props.cartBounce ? "tada" : " "} src="icons/checkout.png" alt="Cart"/>
